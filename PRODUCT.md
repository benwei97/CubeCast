...
The admin workspace shows the target Saturday-Sunday first and uses Draft (red), Active (green), and Complete states. Each draft has a fixed target weekend, defaulting to the next Saturday that has not started. Only competitions overlapping that Saturday or Sunday qualify; retain their full duration, including Thursday starts or Tuesday finishes. Exclude competitions whose pick deadlines have passed. Draft preparation generates market-first recommendations across those global WCA competitions: top-100 event-specific average world ranks are preferred, with top-250 and top-500 tiers searched when needed to target 20 recommendations. WCA Odds probabilities must be between 35% and 65%; final recommendation quality combines competitor relevance and closeness to 50/50, with diversity caps. Publication requires at least 10 markets. Never include another weekend or fabricate odds to fill a contest. Competition dates, the global lock, and delayed settlement remain separate from the target weekend.
