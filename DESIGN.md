...
- **Short-list recovery:** Prefer top-100 matchups and accurately label expanded top-250/top-500 results. Keep failed-registration details collapsed. If fewer than 10 markets qualify, show a clear publication blocker and an explicit Expand window by 7 days action; never silently alter the displayed dates or publish an incomplete contest.
