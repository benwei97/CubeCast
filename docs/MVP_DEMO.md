...
2. On a market preview, check prominent probabilities/score swings and the competitor stats beneath them. Personal-best averages and average world ranks come from WCA records. Expand Recent results and Market rules to inspect details. Stats may stream in later or show a retry notice; odds must stay unchanged.
